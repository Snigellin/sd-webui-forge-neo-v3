...
class ExtraNetworksPageLora(ui_extra_networks.ExtraNetworksPage):
    ...
    def create_item(self, name, index=None, enable_filter=True):
        ...
        preferred_weight = item["user_metadata"].get("preferred weight") or shared.opts.extra_networks_default_multiplier
        item["prompt"] = quote_js(f"<lora:{alias}:{preferred_weight}>")
