...
from scripts.agent_tools_archify import (
    generate_diagram_tool, validate_diagram_tool,
)
from scripts.agent_skills import (
    list_skills_tool, read_skill_tool,
)
from scripts.agent_memory import (
    list_memories_tool, delete_memory_tool,
)
...
TOOL_FUNCTIONS = {
    ...
    "generate_diagram": generate_diagram_tool,
    "validate_diagram": validate_diagram_tool,
