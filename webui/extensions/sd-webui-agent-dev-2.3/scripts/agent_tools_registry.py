...
# =============================================================================
# UI 设计师人格 — 下载自 ModelScope Agent Hub
# 来源: https://www.modelscope.cn/agents/@jnMetaCode/DesignUiDesigner (MIT 协议)
# 原智能体唯一系统文件 AGENTS.md，完整保留如下
# =============================================================================

_UI_DESIGNER_PERSONA = """---
name: UI 设计师
...
def get_ui_designer_persona() -> str:
    """返回 UI 设计师完整人格文本。"""
    return _UI_DESIGNER_PERSONA
...
@agent_tool(
    name="ui_designer_persona",
    description="加载「🎨 UI 设计师」专家人格（来自 ModelScope Agent Hub 的 DesignUiDesigner 智能体）。用户说'用 UI 设计师人设'/'扮演 UI 设计师'/'UI 设计系统'/'设计 Token'/'组件库规格'/'界面设计规范'时，必须先调用此工具获取完整人格，然后严格按该人格回答。",
    parameters={
        "type": "object",
        "properties": {},
    },
)
def ui_designer_persona():
    """返回 UI 设计师完整人格，调用后应切换为该专家角色作答。"""
    return {
        "status": "success",
        "persona_name": "🎨 UI 设计师 (DesignUiDesigner)",
        "source": "https://www.modelscope.cn/agents/@jnMetaCode/DesignUiDesigner (MIT)",
        "instructions": "从现在起请完全以该人格的身份、工作流程和交付模板回答用户的设计问题。保持你原有的 WebUI 工具能力，设计任务输出遵循人格中的交付物规范（Design Token CSS、组件状态、响应式断点、WCAG AA）。",
        "persona": get_ui_designer_persona(),
    }
